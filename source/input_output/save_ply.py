...
def save_ply(
    ...
    d = {}
    d["vertex_x"] = vertices[:,0]
    d["vertex_y"] = vertices[:,1]
    d["vertex_z"] = vertices[:,2]
    # TODO read in PDB file to have atom numbers
    ...
    if iface is not None:
        ...
        d["iface"] = iface
    if cofactor_dist is not None:
        mesh.add_attribute("vertex_cofactor_dist")
        mesh.set_attribute("vertex_cofactor_dist", cofactor_dist)
    if names is not None:
        d["names"] = names.flatten()
