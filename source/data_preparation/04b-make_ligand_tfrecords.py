...
ligands = ["ADP", "COA", "FAD", "HEM", "NAD", "NAP", "SAM","O2IF","N2"]
...
labels_dict = {"ADP": 1, "COA": 2, "FAD": 3, "HEM": 4, "NAD": 5, "NAP": 6, "SAM": 7,"O2IF":8}
...
# np.save('lists/train_pdbs_sequence_100.npy',train_pdbs)
# np.save('lists/val_pdbs_sequence_100.npy',val_pdbs)
# np.save('lists/test_pdbs_sequence_100.npy',test_pdbs)

# For this run use the train, validation and test sets actually used
# train_pdbs = np.load("lists/train_pdbs_sequence_100.npy").astype(str)
# val_pdbs = np.load("lists/val_pdbs_sequence_100.npy").astype(str)
# test_pdbs = np.load("lists/test_pdbs_sequence_100.npy").astype(str)
success = 0
...
with tf.python_io.TFRecordWriter(
    os.path.join(tfrecords_dir, "training_data_sequenceSplit_100.tfrecord")
) as writer:
