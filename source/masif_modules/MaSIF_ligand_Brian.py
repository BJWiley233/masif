...
class MaSIF_ligand2:
    ...
    def inference(
        ...
        for k in range(self.n_rotations):
            ...
            print("gauss_activations shape 3",gauss_activations.shape)
            ...
            print("gauss_activations shape 4",gauss_activations.shape)
            gauss_activations = tf.expand_dims(
                gauss_activations, 2
            )  # batch_size, n_vertices, 1, n_gauss,
            print("gauss_activations shape 5",gauss_activations.shape)
            input_feat_ = tf.expand_dims(
                input_feat, 3
            )  # batch_size, n_vertices, n_feat, 1
            print("input_feat_ shape 1",input_feat_.shape)
